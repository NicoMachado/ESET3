...
-- Volcando estructura de base de datos para esetn3_6to2da_g2
CREATE DATABASE IF NOT EXISTS `esetn3_6to2da_g2` /*!40100 DEFAULT CHARACTER SET latin1 COLLATE latin1_spanish_ci */;
USE `esetn3_6to2da_g2`;

-- Volcando estructura para tabla esetn3_6to2da_g2.profesor
...
-- Volcando datos para la tabla esetn3_6to2da_g2.profesor: ~1 rows (aproximadamente)
...
-- Volcando estructura para tabla esetn3_6to2da_g2.tarea
...
-- Volcando datos para la tabla esetn3_6to2da_g2.tarea: ~1 rows (aproximadamente)
DELETE FROM `tarea`;
...
-- Volcando estructura para tabla esetn3_6to2da_g2.tema
...
-- Volcando datos para la tabla esetn3_6to2da_g2.tema: ~0 rows (aproximadamente)
DELETE FROM `tema`;
